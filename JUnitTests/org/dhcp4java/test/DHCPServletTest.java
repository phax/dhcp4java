...
public class DHCPServletTest {
    ...
    public void testGetDefaultSocketAddress() throws Exception {
    	...
    	// TODO RFC 2131 compliance
    	// TODO
    	// TODO
    	pac.setAddress(InetAddress.getByName("252.10.0.255"));
    	pac.setPort(67);
    	sockAdr = DHCPServlet.getDefaultSocketAddress(pac);
    	assertEquals(InetAddress.getByName("252.10.0.255"), sockAdr.getAddress());
    	assertEquals(67, sockAdr.getPort());
    	//
    	pac.setAddress(InetAddress.getByName("252.10.0.255"));
    	pac.setPort(68);
    	sockAdr = DHCPServlet.getDefaultSocketAddress(pac);
    	assertEquals(InetAddress.getByName("252.10.0.255"), sockAdr.getAddress());
    	assertEquals(67, sockAdr.getPort());	// still on port 67
    	//
    	pac.setAddress(InetAddress.getByName("252.10.0.255"));
    	pac.setGiaddr(InetAddress.getByName("10.11.12.13"));
    	pac.setPort(68);
    	sockAdr = DHCPServlet.getDefaultSocketAddress(pac);
    	assertEquals(InetAddress.getByName("10.11.12.13"), sockAdr.getAddress());
    	assertEquals(68, sockAdr.getPort());	// still on port 67
    }
    @Test (expected=IllegalArgumentException.class)
    public void testGetDefaultSocketAddressNull() {
    	DHCPServlet.getDefaultSocketAddress(null);
    }
}
